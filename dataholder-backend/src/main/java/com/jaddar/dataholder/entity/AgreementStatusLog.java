...
@Table(name = "agreement_status_logs", indexes = {
    @Index(name = "idx_status_log_subscription", columnList = "subscription_id"),
...
public class AgreementStatusLog {
    ...
    /**
     * Reference to the subscription this log entry is for
     */
    ...
    /**
     * Source of the change: DATAHOLDER, AGREEMENT_SERVER, SYSTEM, SCHEDULER
     */
    @Column(name = "source")
