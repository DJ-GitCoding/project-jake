...
@Entity
@Table(name = "rdap_domains")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class RdapDomain {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @Column(name = "ldh_name", nullable = false, unique = true)
     ...
     * When set and isTestData=true, marks this domain as test data.
