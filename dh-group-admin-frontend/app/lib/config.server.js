 ...
 * for dh-group-admin-backend (context path /dh-group-admin). The browser never sees
 * this — only the SSR server (loaders/actions/BFF proxy) talks to the backend.
 */
export const BACKEND_URL =
  process.env.BACKEND_API_URL || "http://dh-group-admin-backend:8083/dh-group-admin";
