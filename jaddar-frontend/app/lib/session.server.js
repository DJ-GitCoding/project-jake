...
/** Store the auth payload: user profile + tokens (tokens AES-encrypted at rest). */
export function setAuth(session, { user, accessToken, idToken, refreshToken }) {
  session.set("user", user);
  session.set("tok", encrypt({ accessToken, idToken, refreshToken }));
}
